...
export const enLangStack: Array<TechBoxProps> = [
    {
...
export const esLangStack: Array<TechBoxProps> = [
    {
        backgroundColor: "#280068",
        color: "#E4DCF0",
        icon: SiCsharp,
        text: "CSharp",
        skills: ["Inyección de dependencias", "Genericos", "Interoperabilidad", "Atributos", "Asincronía", "Interfaces y Structs", "Clases y Abstracción ", "Polimorfismo", ".NET Framework 3 ... 4.8", ".NET Core 3 ... 6"]
    },
    {
        backgroundColor: "#3178c6",
        color: "white",
        icon: SiTypescript,
        text: "TypeScript",
        skills: ["Interfaces", "Clases y Abstracción", "Genericos", "Modulos", "TSX"]
    },
    {
        backgroundColor: "#F0DB4F",
        color: "#323330",
        icon: SiJavascript,
        text: "Javascript",
        skills: ["ES6", "Modulos", "Async/Await", "Manipulacion del DOM"]
    },
    {
        backgroundColor: "#4B8BBE",
        color: "#FFD43B",
        icon: SiPython,
        text: "Python",
        skills: ["Fundamentos del lenguaje", "POO en python", "PiP", "Python as scripting language"]
    },
    {
        backgroundColor: "#CC342D",
        color: "white",
        icon: SiRuby,
        text: "Ruby",
        skills: ["Fundamentos del lenguaje", "POO en Ruby", "Formateo", "RVM", "RubyGems", "Sequel", "PrawnPDF", "Sinatra", "Jekyll"]
    },
    {
        backgroundColor: "#044F88",
        color: "#D5E4F3",
        icon: SiCplusplus,
        text: "C++",
        skills: ["POO en C++", "Uso de archivos cabezera en C++", "C++99"]
    },
    {
        backgroundColor: "#5E97D0",
        color: "#D5E4F3",
        icon: SiC,
        text: "C",
        skills: ["Punteros", "Programas basicos de consola", "Manejo de archivos"]
    },
    {
        backgroundColor: "#0289a2",
        color: "#D5E4F3",
...
export const enFrameworkStack: Array<TechBoxProps> = [
    {
...
export const esFrameworkStack: Array<TechBoxProps> = [
    {
        backgroundColor: "#512bd4",
        color: "white",
        icon: SiDotnet,
    ...
    },
    {
        ...
        icon: DiNodejs,
        text: "NodeJS",
        skills: ["NPM", "Manejo de Archivos", "Manipulacion del SO", "Hilos"]
    },
    {
        backgroundColor: "#CC342D",
        color: "white",
        icon: SiRubyonrails,
        text: "Ruby On Rails",
        skills: ["Enrutamiento", "ActiveRecord", "Uso de Templates", "I18N", "Deployment"]
    },
    {
        backgroundColor: "white",
        color: "#000000",
        icon: SiNextdotjs,
        text: "NextJS",
        skills: ["Enrutamiento", "SSR", "Generación Estatica", "Componentes estilizados", "Deployment"]
    },
    {
        backgroundColor: "#20232a",
        color: "#61DBFB",
        icon: SiReact,
        text: "ReactJS",
        skills: ["Como el DOM de react funciona", "Componentes de función", "Composición", "Renderizado Condicional", "Manejo de Eventos"]
    },
    {
        backgroundColor: "#20232a",
        color: "#61DBFB",
        icon: SiJquery,
        text: "JQuery",
        skills: ["AJAX", "Manejo de Eventos", "Extender Funciones"]
    },
    {
        backgroundColor: "#6610f2",
        color: "white",
        icon: SiBootstrap,
        text: "Bootstrap",
        skills: ["Extender con SASS", "Extender componentes"]
    },
    {
        backgroundColor: "#29BEB0",
        color: "white",
    ...
    },
    {
        ...
        icon: SiTailwindcss,
        text: "TailwindCSS",
        skills: ["Diseño Responsivo"]
    },
]

export const enDBStack: Array<TechBoxProps> = [
    {
...
export const esDBStack: Array<TechBoxProps> = [
    {
        backgroundColor: "red.500",
        color: "white",
        icon: SiMicrosoftsqlserver,
        text: "MSSQL",
        skills: ["Queries", "Stored procedures", "Funciones escalares", "Triggers", "Rollbacks", "Jobs", "Normalización"]
    },
    {
        backgroundColor: "blue.400",
        color: "blue.700",
        icon: SiPostgresql,
        text: "PostgreSQL",
        skills: ["Queries", "Triggers", "Normalización"]
    },
    {
        backgroundColor: "#00758F",
        color: "#F29111",
        icon: SiMysql,
        text: "MySQL",
        skills: ["Queries", "Store procedures", "Triggers", "Normalización"]
    },
    {
        backgroundColor: "#1a3562",
        color: "white",
